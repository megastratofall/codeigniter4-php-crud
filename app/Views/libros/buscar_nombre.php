...
<div class="container my-5">
    <h3>BÚSQUEDA POR NOMBRE DE LIBRO</h3>
    <form id='form' class="d-flex" action="<?= base_url('/libros/buscar_nombre') ?>" method="get">
        <input id="query" class="form-control me-2" type="text" name="query" required><br />
        <input id='buscar' class="btn btn-primary" type="submit" name="enviar" />
